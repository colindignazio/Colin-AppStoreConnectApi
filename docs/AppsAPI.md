...
```swift
    open class func appsMarketplaceSearchDetailGetToOneRelated(id: String, fieldsMarketplaceSearchDetails: [FieldsMarketplaceSearchDetails_appsMarketplaceSearchDetailGetToOneRelated]? = nil, completion: @escaping (_ data: MarketplaceSearchDetailResponse?, _ error: Error?) -> Void)
```
...
AppsAPI.appsMarketplaceSearchDetailGetToOneRelated(id: id, fieldsMarketplaceSearchDetails: fieldsMarketplaceSearchDetails) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func appsPreReleaseVersionsGetToManyRelated(id: String, fieldsPreReleaseVersions: [FieldsPreReleaseVersions_appsPreReleaseVersionsGetToManyRelated]? = nil, limit: Int? = nil, completion: @escaping (_ data: PreReleaseVersionsWithoutIncludesResponse?, _ error: Error?) -> Void)
```
...
```swift
    open class func appsPromotedPurchasesGetToManyRelationship(id: String, limit: Int? = nil, completion: @escaping (_ data: AppPromotedPurchasesLinkagesResponse?, _ error: Error?) -> Void)
```
...
AppsAPI.appsPromotedPurchasesGetToManyRelationship(id: id, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func appsPromotedPurchasesReplaceToManyRelationship(id: String, appPromotedPurchasesLinkagesRequest: AppPromotedPurchasesLinkagesRequest, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
let id = "id_example" // String | the id of the requested resource
let appPromotedPurchasesLinkagesRequest = AppPromotedPurchasesLinkagesRequest(data: [App_relationships_promotedPurchases_data_inner(type: "type_example", id: "id_example")]) // AppPromotedPurchasesLinkagesRequest | List of related linkages

AppsAPI.appsPromotedPurchasesReplaceToManyRelationship(id: id, appPromotedPurchasesLinkagesRequest: appPromotedPurchasesLinkagesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func appsSubscriptionGracePeriodGetToOneRelated(id: String, fieldsSubscriptionGracePeriods: [FieldsSubscriptionGracePeriods_appsSubscriptionGracePeriodGetToOneRelated]? = nil, completion: @escaping (_ data: SubscriptionGracePeriodResponse?, _ error: Error?) -> Void)
```
...
AppsAPI.appsSubscriptionGracePeriodGetToOneRelated(id: id, fieldsSubscriptionGracePeriods: fieldsSubscriptionGracePeriods) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
