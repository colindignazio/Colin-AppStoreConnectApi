...
open class AlternativeDistributionPackageDeltasAPI {
     ...
     */
    @discardableResult
    open class func alternativeDistributionPackageDeltasGetInstance(id: String, fieldsAlternativeDistributionPackageDeltas: [FieldsAlternativeDistributionPackageDeltas_alternativeDistributionPackageDeltasGetInstance]? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AlternativeDistributionPackageDeltaResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return alternativeDistributionPackageDeltasGetInstanceWithRequestBuilder(id: id, fieldsAlternativeDistributionPackageDeltas: fieldsAlternativeDistributionPackageDeltas).execute(apiResponseQueue) { result in
            switch result {
    ...
    open class func alternativeDistributionPackageDeltasGetInstanceWithRequestBuilder(id: String, fieldsAlternativeDistributionPackageDeltas: [FieldsAlternativeDistributionPackageDeltas_alternativeDistributionPackageDeltasGetInstance]? = nil) -> RequestBuilder<AlternativeDistributionPackageDeltaResponse> {
        ...
        let localVariableRequestBuilder: RequestBuilder<AlternativeDistributionPackageDeltaResponse>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
