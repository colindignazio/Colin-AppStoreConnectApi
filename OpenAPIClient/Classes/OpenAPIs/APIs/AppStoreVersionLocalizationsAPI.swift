...
open class AppStoreVersionLocalizationsAPI {
     ...
     */
    @discardableResult
    open class func appStoreVersionLocalizationsCreateInstance(appStoreVersionLocalizationCreateRequest: AppStoreVersionLocalizationCreateRequest, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AppStoreVersionLocalizationResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return appStoreVersionLocalizationsCreateInstanceWithRequestBuilder(appStoreVersionLocalizationCreateRequest: appStoreVersionLocalizationCreateRequest).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func appStoreVersionLocalizationsCreateInstanceWithRequestBuilder(appStoreVersionLocalizationCreateRequest: AppStoreVersionLocalizationCreateRequest) -> RequestBuilder<AppStoreVersionLocalizationResponse> {
        ...
        let localVariableRequestBuilder: RequestBuilder<AppStoreVersionLocalizationResponse>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func appStoreVersionLocalizationsDeleteInstance(id: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
        return appStoreVersionLocalizationsDeleteInstanceWithRequestBuilder(id: id).execute(apiResponseQueue) { result in
            switch result {
            case .success:
                completion((), nil)
            case let .failure(error):
     ...
     */
    @discardableResult
    open class func appStoreVersionLocalizationsGetInstance(id: String, fieldsAppStoreVersionLocalizations: [FieldsAppStoreVersionLocalizations_appStoreVersionLocalizationsGetInstance]? = nil, include: [Include_appStoreVersionLocalizationsGetInstance]? = nil, fieldsAppScreenshotSets: [FieldsAppScreenshotSets_appStoreVersionLocalizationsGetInstance]? = nil, fieldsAppPreviewSets: [FieldsAppPreviewSets_appStoreVersionLocalizationsGetInstance]? = nil, limitAppPreviewSets: Int? = nil, limitAppScreenshotSets: Int? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AppStoreVersionLocalizationResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return appStoreVersionLocalizationsGetInstanceWithRequestBuilder(id: id, fieldsAppStoreVersionLocalizations: fieldsAppStoreVersionLocalizations, include: include, fieldsAppScreenshotSets: fieldsAppScreenshotSets, fieldsAppPreviewSets: fieldsAppPreviewSets, limitAppPreviewSets: limitAppPreviewSets, limitAppScreenshotSets: limitAppScreenshotSets).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    @discardableResult
    open class func appStoreVersionLocalizationsUpdateInstance(id: String, appStoreVersionLocalizationUpdateRequest: AppStoreVersionLocalizationUpdateRequest, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AppStoreVersionLocalizationResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return appStoreVersionLocalizationsUpdateInstanceWithRequestBuilder(id: id, appStoreVersionLocalizationUpdateRequest: appStoreVersionLocalizationUpdateRequest).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
