...
open class InAppPurchaseContentsAPI {
     ...
     */
    @discardableResult
    open class func inAppPurchaseContentsGetInstance(id: String, fieldsInAppPurchaseContents: [FieldsInAppPurchaseContents_inAppPurchaseContentsGetInstance]? = nil, include: [Include_inAppPurchaseContentsGetInstance]? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: InAppPurchaseContentResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return inAppPurchaseContentsGetInstanceWithRequestBuilder(id: id, fieldsInAppPurchaseContents: fieldsInAppPurchaseContents, include: include).execute(apiResponseQueue) { result in
            switch result {
