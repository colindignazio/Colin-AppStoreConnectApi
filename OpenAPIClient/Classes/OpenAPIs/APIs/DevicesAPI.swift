...
open class DevicesAPI {
     ...
     */
    @discardableResult
    open class func devicesCreateInstance(deviceCreateRequest: DeviceCreateRequest, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: DeviceResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return devicesCreateInstanceWithRequestBuilder(deviceCreateRequest: deviceCreateRequest).execute(apiResponseQueue) { result in
            switch result {
    ...
    open class func devicesCreateInstanceWithRequestBuilder(deviceCreateRequest: DeviceCreateRequest) -> RequestBuilder<DeviceResponse> {
        ...
        let localVariableRequestBuilder: RequestBuilder<DeviceResponse>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func devicesGetCollection(filterName: [String]? = nil, filterPlatform: [FilterPlatform_devicesGetCollection]? = nil, filterStatus: [FilterStatus_devicesGetCollection]? = nil, filterUdid: [String]? = nil, filterId: [String]? = nil, sort: [Sort_devicesGetCollection]? = nil, fieldsDevices: [FieldsDevices_devicesGetCollection]? = nil, limit: Int? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: DevicesResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return devicesGetCollectionWithRequestBuilder(filterName: filterName, filterPlatform: filterPlatform, filterStatus: filterStatus, filterUdid: filterUdid, filterId: filterId, sort: sort, fieldsDevices: fieldsDevices, limit: limit).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func devicesGetCollectionWithRequestBuilder(filterName: [String]? = nil, filterPlatform: [FilterPlatform_devicesGetCollection]? = nil, filterStatus: [FilterStatus_devicesGetCollection]? = nil, filterUdid: [String]? = nil, filterId: [String]? = nil, sort: [Sort_devicesGetCollection]? = nil, fieldsDevices: [FieldsDevices_devicesGetCollection]? = nil, limit: Int? = nil) -> RequestBuilder<DevicesResponse> {
        ...
        let localVariableRequestBuilder: RequestBuilder<DevicesResponse>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func devicesGetInstance(id: String, fieldsDevices: [FieldsDevices_devicesGetInstance]? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: DeviceResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return devicesGetInstanceWithRequestBuilder(id: id, fieldsDevices: fieldsDevices).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    @discardableResult
    open class func devicesUpdateInstance(id: String, deviceUpdateRequest: DeviceUpdateRequest, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: DeviceResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return devicesUpdateInstanceWithRequestBuilder(id: id, deviceUpdateRequest: deviceUpdateRequest).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
