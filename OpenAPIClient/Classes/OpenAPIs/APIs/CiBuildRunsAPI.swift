...
open class CiBuildRunsAPI {
     ...
     */
    @discardableResult
    open class func ciBuildRunsActionsGetToManyRelated(id: String, fieldsCiBuildRuns: [FieldsCiBuildRuns_ciBuildRunsActionsGetToManyRelated]? = nil, fieldsCiBuildActions: [FieldsCiBuildActions_ciBuildRunsActionsGetToManyRelated]? = nil, limit: Int? = nil, include: [Include_ciBuildRunsActionsGetToManyRelated]? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CiBuildActionsResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return ciBuildRunsActionsGetToManyRelatedWithRequestBuilder(id: id, fieldsCiBuildRuns: fieldsCiBuildRuns, fieldsCiBuildActions: fieldsCiBuildActions, limit: limit, include: include).execute(apiResponseQueue) { result in
            switch result {
    ...
    open class func ciBuildRunsActionsGetToManyRelatedWithRequestBuilder(id: String, fieldsCiBuildRuns: [FieldsCiBuildRuns_ciBuildRunsActionsGetToManyRelated]? = nil, fieldsCiBuildActions: [FieldsCiBuildActions_ciBuildRunsActionsGetToManyRelated]? = nil, limit: Int? = nil, include: [Include_ciBuildRunsActionsGetToManyRelated]? = nil) -> RequestBuilder<CiBuildActionsResponse> {
        ...
        let localVariableRequestBuilder: RequestBuilder<CiBuildActionsResponse>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ciBuildRunsCreateInstance(ciBuildRunCreateRequest: CiBuildRunCreateRequest, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CiBuildRunResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return ciBuildRunsCreateInstanceWithRequestBuilder(ciBuildRunCreateRequest: ciBuildRunCreateRequest).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
