...
open class AppCustomProductPageLocalizationsAPI {
     ...
     */
    @discardableResult
    open class func appCustomProductPageLocalizationsCreateInstance(appCustomProductPageLocalizationCreateRequest: AppCustomProductPageLocalizationCreateRequest, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AppCustomProductPageLocalizationResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return appCustomProductPageLocalizationsCreateInstanceWithRequestBuilder(appCustomProductPageLocalizationCreateRequest: appCustomProductPageLocalizationCreateRequest).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func appCustomProductPageLocalizationsCreateInstanceWithRequestBuilder(appCustomProductPageLocalizationCreateRequest: AppCustomProductPageLocalizationCreateRequest) -> RequestBuilder<AppCustomProductPageLocalizationResponse> {
        ...
        let localVariableRequestBuilder: RequestBuilder<AppCustomProductPageLocalizationResponse>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func appCustomProductPageLocalizationsDeleteInstance(id: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
        return appCustomProductPageLocalizationsDeleteInstanceWithRequestBuilder(id: id).execute(apiResponseQueue) { result in
            switch result {
            case .success:
                completion((), nil)
            case let .failure(error):
    ...
    open class func appCustomProductPageLocalizationsGetInstance(id: String, fieldsAppCustomProductPageLocalizations: [FieldsAppCustomProductPageLocalizations_appCustomProductPageLocalizationsGetInstance]? = nil, include: [Include_appCustomProductPageLocalizationsGetInstance]? = nil, fieldsAppScreenshotSets: [FieldsAppScreenshotSets_appCustomProductPageLocalizationsGetInstance]? = nil, fieldsAppPreviewSets: [FieldsAppPreviewSets_appCustomProductPageLocalizationsGetInstance]? = nil, limitAppPreviewSets: Int? = nil, limitAppScreenshotSets: Int? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AppCustomProductPageLocalizationResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return appCustomProductPageLocalizationsGetInstanceWithRequestBuilder(id: id, fieldsAppCustomProductPageLocalizations: fieldsAppCustomProductPageLocalizations, include: include, fieldsAppScreenshotSets: fieldsAppScreenshotSets, fieldsAppPreviewSets: fieldsAppPreviewSets, limitAppPreviewSets: limitAppPreviewSets, limitAppScreenshotSets: limitAppScreenshotSets).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    @discardableResult
    open class func appCustomProductPageLocalizationsUpdateInstance(id: String, appCustomProductPageLocalizationUpdateRequest: AppCustomProductPageLocalizationUpdateRequest, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AppCustomProductPageLocalizationResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return appCustomProductPageLocalizationsUpdateInstanceWithRequestBuilder(id: id, appCustomProductPageLocalizationUpdateRequest: appCustomProductPageLocalizationUpdateRequest).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
