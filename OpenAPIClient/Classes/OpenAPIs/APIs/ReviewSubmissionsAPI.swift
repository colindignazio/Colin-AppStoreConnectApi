...
open class ReviewSubmissionsAPI {
     ...
     */
    @discardableResult
    open class func reviewSubmissionsCreateInstance(reviewSubmissionCreateRequest: ReviewSubmissionCreateRequest, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ReviewSubmissionResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return reviewSubmissionsCreateInstanceWithRequestBuilder(reviewSubmissionCreateRequest: reviewSubmissionCreateRequest).execute(apiResponseQueue) { result in
            switch result {
    ...
    open class func reviewSubmissionsCreateInstanceWithRequestBuilder(reviewSubmissionCreateRequest: ReviewSubmissionCreateRequest) -> RequestBuilder<ReviewSubmissionResponse> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ReviewSubmissionResponse>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    open class func reviewSubmissionsGetCollection(filterApp: [String], filterPlatform: [FilterPlatform_reviewSubmissionsGetCollection]? = nil, filterState: [FilterState_reviewSubmissionsGetCollection]? = nil, fieldsReviewSubmissions: [FieldsReviewSubmissions_reviewSubmissionsGetCollection]? = nil, limit: Int? = nil, include: [Include_reviewSubmissionsGetCollection]? = nil, fieldsReviewSubmissionItems: [FieldsReviewSubmissionItems_reviewSubmissionsGetCollection]? = nil, limitItems: Int? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ReviewSubmissionsResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return reviewSubmissionsGetCollectionWithRequestBuilder(filterApp: filterApp, filterPlatform: filterPlatform, filterState: filterState, fieldsReviewSubmissions: fieldsReviewSubmissions, limit: limit, include: include, fieldsReviewSubmissionItems: fieldsReviewSubmissionItems, limitItems: limitItems).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    @discardableResult
    open class func reviewSubmissionsGetInstance(id: String, fieldsReviewSubmissions: [FieldsReviewSubmissions_reviewSubmissionsGetInstance]? = nil, include: [Include_reviewSubmissionsGetInstance]? = nil, fieldsReviewSubmissionItems: [FieldsReviewSubmissionItems_reviewSubmissionsGetInstance]? = nil, limitItems: Int? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ReviewSubmissionResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return reviewSubmissionsGetInstanceWithRequestBuilder(id: id, fieldsReviewSubmissions: fieldsReviewSubmissions, include: include, fieldsReviewSubmissionItems: fieldsReviewSubmissionItems, limitItems: limitItems).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func reviewSubmissionsItemsGetToManyRelatedWithRequestBuilder(id: String, fieldsAppStoreVersionExperiments: [FieldsAppStoreVersionExperiments_reviewSubmissionsItemsGetToManyRelated]? = nil, fieldsReviewSubmissionItems: [FieldsReviewSubmissionItems_reviewSubmissionsItemsGetToManyRelated]? = nil, fieldsAppStoreVersions: [FieldsAppStoreVersions_reviewSubmissionsItemsGetToManyRelated]? = nil, fieldsAppCustomProductPageVersions: [FieldsAppCustomProductPageVersions_reviewSubmissionsItemsGetToManyRelated]? = nil, fieldsAppEvents: [FieldsAppEvents_reviewSubmissionsItemsGetToManyRelated]? = nil, limit: Int? = nil, include: [Include_reviewSubmissionsItemsGetToManyRelated]? = nil) -> RequestBuilder<ReviewSubmissionItemsResponse> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ReviewSubmissionItemsResponse>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func reviewSubmissionsUpdateInstance(id: String, reviewSubmissionUpdateRequest: ReviewSubmissionUpdateRequest, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ReviewSubmissionResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return reviewSubmissionsUpdateInstanceWithRequestBuilder(id: id, reviewSubmissionUpdateRequest: reviewSubmissionUpdateRequest).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
